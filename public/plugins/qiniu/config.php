...
return [
    'accessKey'                 => [// 在后台插件配置表单中的键名 ,会是config[text]
        ...
        'tip'     => '<a href="https://portal.qiniu.com/signup?code=3lfihpz361o42" target="_blank">马上获取</a>,充值使用布光科技七牛专属优惠码<a href="http://www.布光科技.com/qiniu/promotion_code.html" target="_blank">507670e8</a>有更多优惠' //表单的帮助提示
    ],
